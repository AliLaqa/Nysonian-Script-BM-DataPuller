...
const WEBHOOK_SCHEDULER = {
    // Scheduling settings
    DEFAULT_INTERVAL_MINUTES: 15, // Default interval between webhook runs
    MAX_INTERVAL_MINUTES: 1440,   // Maximum interval (24 hours)
    MIN_INTERVAL_MINUTES: 1,      // Minimum interval (1 minute)
    
    // Concurrency and performance
    MAX_CONCURRENT_DEVICES: 3,    // Process max 3 devices simultaneously
    BATCH_DELAY_MS: 1000,        // Delay between device batches
    ...
    // Timeout settings
    REQUEST_TIMEOUT_MS: 30000,    // 30 second timeout for webhook requests
    
    // Monitoring and logging
    LOG_DETAILED_RESULTS: true,   // Log detailed results for each device
    TRACK_DEVICE_RESULTS: true,   // Track results per device for monitoring
